...
import { getAesKey, encryptJSON, decryptJSON, validateBearerJWT } from '../lib/security'
...
describe('security utils', () => {
  ...
  it('rejects JWT when claims mismatch', async () => {
    ...
    const bad = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJub3QiLCJpc3MiOiJub3QiLCJleHAiOjF9.sig'
    const res = await validateBearerJWT(bad, { iss: 'expected', aud: 'expected' })
