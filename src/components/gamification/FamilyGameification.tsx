...
import { Trophy, Target, Crown, Medal, Flame, Star, TrendingUp, Calendar, Users } from '@phosphor-icons/react'
...
interface FamilyActivity {
  ...
  memberId: string
  memberName: string
  type: 'challenge_completed' | 'goal_achieved' | 'streak_milestone' | 'level_up'
  description: string
  points: number
  timestamp: string
  icon: string
...
export default function FamilyGameification() {
  ...
  const [familyActivities, setFamilyActivities] = useKV<FamilyActivity[]>('family-activities', [])
  ...
  const currentMembers = familyMembers.length > 0 ? familyMembers : sampleMembers
  const currentActivities = familyActivities.length > 0 ? familyActivities : sampleActivities
  ...
  const getFamilyStats = () => {
    return {
      ...
      activeGoals: currentGoals.filter(g => new Date(g.endDate) > new Date()).length,
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Family member rankings for this week</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {currentMembers.slice(0, 3).map((member, index) => (
                    <div key={member.id} className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                      ...
                      <div className="text-right">
                        <p className="font-bold">{Math.floor(Math.random() * 1000 + 500)} pts</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Collaborative challenges for the whole family</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="members" className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Manage your family health monitoring group</p>
            </div>
        ...
        <TabsContent value="goals" className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Collaborative health challenges for the entire family</p>
            </div>
            <Button>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {goal.participants.map((participantId) => {
                        const member = currentMembers.find(m => m.id === participantId)
                        return member ? (
        ...
        <TabsContent value="activity" className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground">Recent achievements and milestones from your family</p>
          </div>
