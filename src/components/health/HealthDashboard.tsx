    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {fallRiskFactors?.filter((f) => f.risk === 'high').length > 0
                ? 'High'
                : fallRiskFactors?.filter((f) => f.risk === 'moderate').length >
                    0
                  ? 'Moderate'
                  : 'Low'}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div
              className={`text-2xl font-bold capitalize ${getDataQualityColor()}`}
            >
