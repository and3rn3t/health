...
const AIRecommendations = ({ healthData }: AIRecommendationsProps) => {
  ...
  const [lastGenerated, setLastGenerated] = useKV<string>(
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Personalized interventions powered by AI analysis of your health
            data
          </p>
        </div>
        <Button
      ...
      {totalRecommendations > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your health improvement journey</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
                <div className="mb-2 flex justify-between text-sm">
                  ...
                  <span>
                    {completedCount}/{totalRecommendations} completed
                  </span>
                </div>
