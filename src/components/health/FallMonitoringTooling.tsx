...
const toolingRequirements: ToolingRequirement[] = [
  // Hardware Requirements
  {
    ...
    description: 'Primary fall detection sensor with built-in accelerometer and gyroscope',
    status: 'required',
    category: 'hardware',
    implementation: 'Apple Watch Fall Detection API - automatically detects hard falls',
    cost: '$249 - $799'
  },
  {
    name: 'iPhone (iOS 14+)',
    ...
    status: 'required',
    category: 'hardware', 
    implementation: 'HealthKit integration for sensor data and emergency calling',
    cost: '$429 - $1,199'
  },
  {
    name: 'Smart Home Sensors',
    description: 'Motion sensors, cameras, or smart floor mats for comprehensive monitoring',
    status: 'optional',
    category: 'hardware',
  ...
  // Software Requirements  
  {
    ...
    status: 'available',
    category: 'software',
    implementation: 'HKHealthStore API for real-time accelerometer and motion data',
    cost: 'Free with iOS'
  },
  {
    name: 'Core Motion',
...
const monitoringFlow: MonitoringFlow[] = [
  {
    ...
    description: 'Apple Watch continuously monitors accelerometer, gyroscope, and motion patterns',
  ...
  },
  {
    ...
    description: 'ML model analyzes motion data to distinguish falls from normal activities',
  ...
  },
  {
    ...
    description: 'If no response, automatically contacts emergency services and caregivers',
  ...
  },
  {
    ...
    description: 'Precise GPS coordinates shared with emergency contacts and responders',
  ...
  },
  {
    ...
    description: 'Fall details recorded for medical review and pattern analysis',
...
export default function FallMonitoringTooling() {
  const [selectedCategory, setSelectedCategory] = useState<'all' | 'hardware' | 'software' | 'service'>('all')
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'hardware': return <DeviceMobile className="h-4 w-4" />
      case 'software': return <Gear className="h-4 w-4" />
    ...
    <div className="space-y-6">
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-800">
          <strong>Real-time fall monitoring requires comprehensive infrastructure.</strong> This page outlines 
          the technical requirements, costs, and implementation details needed for actual fall detection.
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="requirements" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Comprehensive list of hardware, software, and services needed for real-time fall detection
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {filteredRequirements.map((req, index) => (
                  <div key={index} className="border rounded-lg p-4 space-y-3">
                    ...
                    <div className="bg-muted/50 rounded p-3">
                      <p className="text-sm"><strong>Implementation:</strong> {req.implementation}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <TabsContent value="workflow" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Step-by-step process from initial detection to emergency response
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                  ...
                  <div key={index} className="flex gap-4">
                    ...
                    <div className="flex-1 pb-8">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium">{step.technology}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <CardContent>
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>Medical Device Regulations:</strong> Fall detection systems may require FDA approval for medical claims.
                    </AlertDescription>
                  </Alert>
