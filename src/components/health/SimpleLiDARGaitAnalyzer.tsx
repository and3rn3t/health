/**
 * Simple LiDAR Gait Analyzer Component
...
interface SimpleLiDARGaitAnalyzerProps {
  readonly onSessionComplete?: (session: LiDARSession) => void;
  readonly maxSessionDuration?: number;
}

export function SimpleLiDARGaitAnalyzer({
  onSessionComplete,
  maxSessionDuration = 30,
}: SimpleLiDARGaitAnalyzerProps) {
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="metrics" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">Temporal Metrics</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <div className="flex justify-between">
                      <span>Cadence:</span>
