...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active=true]:focus:bg-slate-100 data-[active=true]:hover:bg-slate-100 data-[active=true]:bg-accent/50 data-[active=true]:text-slate-900 hover:bg-slate-100 hover:text-slate-900 focus:bg-slate-100 focus:text-slate-900 focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-slate-500 flex flex-col gap-1 rounded-sm p-2 text-sm outline-none transition-all focus-visible:outline-1 focus-visible:ring-[3px] [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
