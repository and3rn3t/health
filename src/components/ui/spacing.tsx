...
export function SpacedSection({
  ...
  return (
    <section
      className={cn(COMPONENT_SPACING.section.padding, spaceClass, className)}
      {...props}
    >
      {children}
    </section>
...
export function SpacedContainer({
  ...
  return (
    <div
      className={cn('mx-auto', maxWidthClass, spacingClass, className)}
      {...props}
    >
      {children}
    </div>
...
export function SpacedGrid({
  ...
  return (
    <div className={cn('grid', colsClass, gapClass, className)} {...props}>
      {children}
    </div>
  );
}
...
export function SpacedStack({
  ...
  const spaceClass =
    direction === 'vertical' ? SPACING[spacing].space : SPACING[spacing].gap;

  const flexClass =
    direction === 'vertical' ? 'flex flex-col' : 'flex flex-row items-center';

  return (
    <div className={cn(flexClass, spaceClass, className)} {...props}>
      {children}
    </div>
  );
}
