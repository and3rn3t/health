...
export const ios26IconCategories = {
  health: ['heart', 'activity', 'steps', 'sleep', 'brain', 'wellness', 'pulse', 'gauge'] as const,
  status: ['warning', 'success', 'error', 'info', 'alert', 'shield', 'shield-check'] as const,
  navigation: ['home', 'profile', 'settings', 'search', 'back', 'menu'] as const,
  system: ['close', 'check', 'plus', 'minus', 'edit', 'delete', 'share', 'download'] as const,
  medical: ['pill', 'thermometer', 'stethoscope', 'medical', 'emergency', 'bandage'] as const,
  analytics: ['chart', 'graph', 'analytics', 'trend', 'meter', 'scale'] as const,
} as const;
