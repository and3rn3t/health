...
class AdvancedHealthMetrics: ObservableObject {
    ...
    private func fetchEnvironmentalAudio() async {
        ...
        let query = HKStatisticsQuery(
            ...
            DispatchQueue.main.async {
                // Use a generic decibel unit to maintain compatibility across iOS versions.
                self?.environmentalAudioExposure = average.doubleValue(for: HKUnit.decibel())
            }
        }
