...
struct GaitShowcaseHomeView: View {
    ...
    @State private var stabilityIndex: Float = 1.0
            ...
            HStack(alignment: .center) {
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    if #available(iOS 17.0, *) {
                        ProtocolTip().popoverTip(.constant(true))
                    }
#endif
                ...
                .buttonStyle(lidar.isRunning ? .bordered : .borderedProminent)
            }
        }
    }
...
#if canImport(TipKit)
                    if #available(iOS 17.0, *) {
                        ARSpaceTip().popoverTip(.constant(true))
                    }
#endif
                }
                Spacer()
...
private extension GaitShowcaseHomeView {
    func goalDistance(for proto: ProtocolType) -> Float? {
        switch proto {
        case .tenMWT: return 10
        case .tug: return 3
        default: return nil
        }
    }
