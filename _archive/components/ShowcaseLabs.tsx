// @ts-nocheck
// Archived: Labs & Showcase page (moved out after extracting Developer Tools)
// This file is preserved for reference and demos.
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-foreground flex items-center gap-2 text-2xl font-bold">
            ...
            Labs & Showcase (Archived)
          </h2>
          <p className="text-muted-foreground">
            This page has been archived after extracting Developer Tools.
          </p>
        </div>
