...
if ($args -contains "-Verbose") {
    Initialize-VitalSenseEnvironment -WorkspaceRoot $PSScriptRoot.Replace('\scripts', '') -Verbose
} else {
    Initialize-VitalSenseEnvironment -WorkspaceRoot $PSScriptRoot.Replace('\scripts', '')
}
