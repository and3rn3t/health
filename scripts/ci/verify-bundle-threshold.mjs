...
// Default budgets (gzip): JS < 900KB, CSS < 60KB
// Increased from 450KB to accommodate React 19, new features, and expanded functionality
const distDir = args.dir || 'dist';
const jsMax = parseSize(args['js-max'], 900 * 1024);
